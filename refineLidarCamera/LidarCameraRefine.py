...
#     dataset = SyncDataset(Path("../dataset-sdv-feb28_calib"))
...
#     dataset = SyncDataset(Path("../sync_one_4mar"))
#     total = dataset.num_scenes()
#     print(f"Total scenes: {total}")
...
#     config_dir = Path("camera_configs_marz")
...
#     dataset = SyncDataset(Path("../dataset-sdv-mar6"))
#     total = dataset.num_scenes()
#     print(f"Total scenes: {total}")
...
#     config_dir = Path("camera_configs_mar6")
...
#     dataset = SyncDataset(Path("../dataset-sdv-mar6-2"))
#     total = dataset.num_scenes()
#     print(f"Total scenes: {total}")
...
#     config_dir = Path("camera_configs_mar6-2")
